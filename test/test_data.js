module.exports = {
	users: [
		{
			...
			"pers_is_active": true,
			"pers_scope": "admin",
			"pers_username": "bohnebernhard",
			"pers_password": "bernhard55",
			"pers_addresses": [
				{
		...
		},
		{
			...
			"pers_username": "wirriesklaus",
			"pers_password": "klaus51+",
			"pers_addresses": [
				{
		...
		{
			"pers_firstname": "Petra",
			"pers_lastname": "Geyer",
			"pers_is_active": true,
			"pers_scope": "inspector",
			"pers_username": "petrageyer",
			"pers_password": "petra2017",
			"pers_addresses": [
				{
					"address_street_name": "Fuggerstr.",
					"address_street_number": "6",
					"address_zipcode": "86911",
					"address_city": "Diessen-Obermühlhausen",
					"address_country": "Deutschland",
					"address_type": "home"
				}
			],
			"pers_email_addresses": [
				{
					"email_address": "p.geyer@hotmail.de",
					"email_type": "home",
					"email_notification_time": "9"
				}
			],
		...
		{
			"pers_firstname": "Petra",
			"pers_lastname": "MANAGER Geyer",
			"pers_is_active": true,
			"pers_scope": "manager",
			"pers_username": "petramanagergeyer",
			"pers_password": "petram2017",
			"pers_addresses": [
				{
		...
		{
			"pers_firstname": "BIG Hausverwaltung GmbH",
			"pers_lastname": "zu Hd. Hr. Bohne",
			"pers_is_active": true,
			"pers_scope": "owner",
			"pers_username": "bighausverwaltung",
			"pers_password": "bighv4000",
			"pers_addresses": [
				{
					"address_street_name": "Bahnhofstr. ",
					"address_street_number": "20",
			...
			"pers_email_addresses": [
				{
					"email_address": "b.bohne@big-hausverwaltung.de",
					"email_type": "work",
					"email_notification_time": "8"
				}
			],
			"pers_phone_numbers": [
				{
					"phone_number": "08152-922660",
					"phone_type": "work"
				}
			]
		},
		{
			"pers_firstname": "Marcus",
			"pers_lastname": "Beilacher",
			"pers_is_active": true,
			"pers_scope": "owner",
			"pers_username": "marcusbeilacher",
			"pers_password": "beilacher2020",
			"pers_addresses": [
				{
					"address_street_name": "Bahnhofstr.",
					"address_street_number": "20",
			...
			"pers_email_addresses": [
				{
					"email_address": "marcus.beilacher@big-wohnbau.de",
					"email_type": "work",
					"email_notification_time": "10"
				}
			],
			"pers_phone_numbers": [
				{
					"phone_number": "08152-922815",
					"phone_type": "work"
				}
			]
		},
		{
			...
			"pers_is_active": true,
			"pers_scope": "inspector",
			"pers_username": "bernhardawbohne",
			"pers_password": "bernhard51+",
			"pers_addresses": [
				{
					"address_street_name": "Rudolf-Hanauer-Str. ",
					"address_street_number": "1",
	...
	checkpoints:[
		...
		{
			"chpo_headline": "AUFZUGFAHRT DURCHFÜHREN",
			"chpo_description": "Fahren Sie bis zur obersten und untersten Haltestelle und achten Sie darauf, ob der Fahrstuhl während der Fahrt „ruckelt“, irgendwo „anstößt“, anormale Schleif- oder Kratzgeräusche zu hören sind oder ob die Kabine bei der Fahrt gar zwischen Haltestellen stockt.",
			"chpo_long_description": "Beschreiben Sie alle Mängel möglichst genau. Achten sie auch darauf, auf bzw. zwischen welchen Etagen Störungen auftauchen, und benennen Sie das im Text der Mangelbeschreibung.",
			"chpo_priority": 1,
			"chpo_emergency_description": "Falls zu befürchten ist, dass der Aufzug stecken bleiben könnte, oder dass beim Weiterbetrieb größere Schäden entstehen können, müssen Sie SOFORT telefonisch  den Verwalter/Betreiber sowie den Hausmeister informieren (Rufnummern: siehe Notfallplan). Bitte schalten Sie den Aufzug über den Hauptschalter im Aufzugmaschinenraum ab und informieren Sie den Hauseigentümer/Verwalter darüber.",
			"chpo_checklists": null
		},
		{
		...
		{
			"chpo_headline": "SCHACHTWÄNDE OHNE BESCHÄDIGUNGEN",
			"chpo_description": "Prüfen Sie während der Fahrt, ob die Schachtwände frei von Schäden sind. ",
			"chpo_long_description": "Das betrifft nur Aufzüge OHNE Innentüre. Hier ist vor allem darauf zu achten, ob an den Schachtwänden Teile des Putzes oder des Mauerwerks herausgebrochen sind. Hier besteht die Gefahr, dass ein Teil der Ladung während der Fahrt verrutscht, und sich dann im Bereich solcher Beschädigungen verkeilt.",
			"chpo_priority": 0,
			"chpo_emergency_description": "",
			"chpo_checklists": null
		},
		{
			"chpo_headline": "AUFZUGMASCHINENRAUM (IM DACH) VERSCHLOSSEN UND FREI ZUGÄNGLICH",
			"chpo_description": "Prüfen Sie, ob der Zugang zum Aufzugmaschinenraum frei zugänglich ist und ob die Türe verschlossen ist. ",
			"chpo_long_description": "Nicht jeder Gegenstand der im Gang vor dem Aufzugmaschinenraum steht, ist ein Problem. Es kommt darauf an, ob jemand, der zur Personenbefreiung schnell in den Aufzugmaschinenraum hinein muss, dies auch ungehindert kann. \t\nEs kommt öfters vor, dass die Schließzylinder „hakeln“ bzw. die Türen klemmen. Letzteres vor allem bei alten Aufzugmaschinenräumen. Seien Sie hier bitte nicht zu vorsichtig. Probieren Sie bei hakelnden Schließzylindern etwas herum. Wenn es sehr schwierig ist, bitte als Mangel eintragen und im Text genauer beschreiben. \nOft klemmen die Türen. Das ist vor allem bei den brandsicheren Metalltüren der Aufzugmaschinenräume öfters der Fall. Wenn sich der Schlüssel nicht drehen lässt, probieren Sie es damit, etwas an der Türe zu ziehen oder gegen die Tür zu drücken, damit der Riegel des Türschlosses sich bewegen kann, der durch eine verzogene Tür eingeklemmt ist. Wenn der Riegel dann mit dem Schlüssel aufgesperrt ist, muss bei verzogenen Türen evtl. etwas fester gezogen oder gedrückt werden, damit sie aufgehen. Ein solches Verklemmen einer verzogenen Türe sollte nur als Mangel eingetragen werden, wenn es wirklich schlimm ist. Dann bitte eine genauere Beschreibung dazu im Text eingeben.",
			"chpo_priority": 0,
			"chpo_emergency_description": "",
			"chpo_checklists": null
		},
		{
			"chpo_headline": "AUFZUGMASCHINENRAUM (IM DACH) SAUBER UND FREI VON FREMDEN GEGENSTÄNDEN",
			"chpo_description": "Alle im Aufzugmaschinenraum installierten Bauteile des Aufzugs müssen für einen Monteur frei zugänglich sein. Auch der Arbeitsbereich des Monteurs um diese Bauteile herum muss frei von fremden Gegenständen sein. ",
			"chpo_long_description": "Wenn Sie keinen Schlüssel/Zugang zum Triebwerksraum haben, kreuzen Sie „Prüfung weist Mangel auf“ an, und schreiben Sie: KEIN ZUGANG in das Textfeld.\t\nAn die Sauberkeit im Triebwerksraum dürfen keine überzogenen Ansprüche gestellt werden. Das ist ein Handwerker-Arbeitsplatz.\nGelagerte Gegenstände: Es ist in der APP bewusst als Frage formuliert, ob solche betriebsfremden Gegenstände entfernt werden müssen; denn: In praktisch ALLEN Häusern mangelt es an Lagerraum für Vorräte und Ersatzmaterialien wie z.B. Leuchtmittel, Reservefliesen, Reserve-Dachpfannen etc. Die Aufzugmaschinenräume sind je nach Lage im Haus auch unterschiedlich groß. Zu prüfen ist: Sind die Einrichtungen und Maschinenteile der Aufzugsanlagen (Schaltschrank, Hydraulikeinheit, Motor etc.) für den Aufzugmonteur frei zugänglich und wird er in seiner Bewegungsfreiheit zum Arbeiten nicht eingeschränkt?",
			"chpo_priority": 0,
			"chpo_emergency_description": "",
			"chpo_checklists": null
		},
		{
			"chpo_headline": "NOTENTRIEGELUNGSSCHLÜSSEL (DG) VORHANDEN",
			"chpo_description": "Prüfen Sie, ob im Aufzugmaschinenraum ein Notentriegelungsschlüssel hinterlegt ist.",
			"chpo_long_description": "Achtung: Die Notentriegelungsschlüssel sind fast immer da, aber oft \"gut versteckt\". Manchmal liegen sie in Aufzugmaschinenräumen auf den Schaltschränken, oft in den Schaltschränken, oder, noch besser: Sie sind im Schaltschrank irgendwo zwischen die Relais oder sonstige Bauteile reingesteckt. \t\nWenn der Schaltschrank mit einem Dreikant zu öffnen ist, UND wenn die Notentriegelung mit einem Dreikant geht, ist bei diesem Punkt IMMER „ohne Mängel“ anzukreuzen.\nWenn der Notentriegelungsschlüssel fehlt, ist \"Prüfung weist Mängel auf\" anzuklicken. Bitte tragen Sie im Textfeld ein, ob man einen normalen Dreikant braucht, oder ob ein spezieller Schlüssel benötigt wird. (Das kann man an den Aufzugtüren sehen, gegebenenfalls mit Dreikant testen)",
			"chpo_priority": 0,
			"chpo_emergency_description": "",
			"chpo_checklists": null
		},
		{
			"chpo_headline": "SCHALTSCHRANK VERSCHLOSSEN",
			"chpo_description": "Prüfen Sie, ob der Schaltschrank des Aufzugs verschlossen ist. ",
			"chpo_long_description": "Dieser Prüfpunkt betrifft nur Aufzüge OHNE Aufzugmaschinenraum. \nFalls der Schaltschrank nicht fest verschlossen ist, können Sie diesen meist durch einfaches Zudrücken der Schaltschranktüre schließen.",
			"chpo_priority": 0,
			"chpo_emergency_description": "",
			"chpo_checklists": null
		},
		...
		{
			"chpo_headline": "AUFZUGMASCHINENRAUM (IM KELLER) VERSCHLOSSEN UND FREI ZUGÄNGLICH",
			"chpo_description": "Prüfen Sie, ob der Zugang zum Aufzugmaschinenraum frei zugänglich ist und ob die Türe verschlossen ist. ",
			"chpo_long_description": "Nicht jeder Gegenstand der im Gang vor dem Aufzugmaschinenraum steht, ist ein Problem. Es kommt darauf an, ob jemand, der zur Personenbefreiung schnell in den Aufzugmaschinenraum hinein muss, dies auch ungehindert kann.\t\nEs kommt öfters vor, dass die Schließzylinder „hakeln“ bzw. die Türen klemmen. Letzteres vor allem bei alten Aufzugmaschinenräumen. Seien Sie hier bitte nicht zu vorsichtig. Probieren Sie bei hakelnden Schließzylindern etwas herum. Wenn es sehr schwierig ist, bitte als Mangel eintragen und im Text genauer beschreiben. \nOft klemmen die Türen. Das ist vor allem bei den brandsicheren Metalltüren der Aufzugmaschinenräume öfters der Fall. Wenn sich der Schlüssel nicht drehen lässt, probieren Sie es damit, etwas an der Türe zu ziehen oder gegen die Tür zu drücken, damit der Riegel des Türschlosses sich bewegen kann, der durch eine verzogene Tür eingeklemmt ist. Wenn der Riegel dann mit dem Schlüssel aufgesperrt ist, muss bei verzogenen Türen evtl. etwas fester gezogen oder gedrückt werden, damit sie aufgehen. Ein solches Verklemmen einer verzogenen Türe sollte nur als Mangel eingetragen werden, wenn es wirklich schlimm ist. Dann bitte eine genauere Beschreibung dazu im Text eingeben.",
			"chpo_priority": 0,
			"chpo_emergency_description": "",
		...
		{
			"chpo_headline": "AUFZUGMASCHINENRAUM (IM KELLER) SAUBER UND FREI VON FREMDEN GEGENSTÄNDEN",
			"chpo_description": "Alle im Aufzugmaschinenraum installierten Bauteile des Aufzugs müssen für einen Monteur frei zugänglich sein. Auch der Arbeitsbereich des Monteurs um diese Bauteile herum muss frei von fremden Gegenständen sein. ",
			"chpo_long_description": "Wenn Sie keinen Schlüssel/Zugang zum Triebwerksraum haben, kreuzen Sie „Prüfung weist Mangel auf“ an, und schreiben Sie: KEIN ZUGANG in das Textfeld.\t\nAn die Sauberkeit im Triebwerksraum dürfen keine überzogenen Ansprüche gestellt werden. Das ist ein Handwerker-Arbeitsplatz.\nGelagerte Gegenstände: Nicht immer müssen ALLE betriebsfremden Gegenstände entfernt werden; denn: In praktisch ALLEN Häusern mangelt es an Lagerraum für Vorräte und Ersatzmaterialien wie z.B. Leuchtmittel, Reservefliesen, Reserve-Dachpfannen etc. Die Aufzugmaschinenräume sind je nach Lage im Haus auch unterschiedlich groß. Zu prüfen ist: Sind die Einrichtungen und Maschinenteile der Aufzugsanlagen (Schaltschrank, Hydraulikeinheit, Motor etc.) für den Aufzugmonteur frei zugänglich und wird er in seiner Bewegungsfreiheit zum Arbeiten nicht eingeschränkt?",
			"chpo_priority": 0,
			"chpo_emergency_description": "",
			"chpo_checklists": null
		},
		{
			"chpo_headline": "NOTENTRIEGELUNGSSCHLÜSSEL (KG) VORHANDEN",
			"chpo_description": "Prüfen Sie, ob im Aufzugmaschinenraum ein Notentriegelungsschlüssel hinterlegt ist.",
			"chpo_long_description": "Achtung: Die Notentriegelungsschlüssel sind fast immer da, aber oft \"gut versteckt\". Manchmal liegen sie in Aufzugmaschinenräumen auf den Schaltschränken, oft in den Schaltschränken, oder, noch besser: Sie sind im Schaltschrank irgendwo zwischen die Relais oder sonstige Bauteile reingesteckt. \t\nWenn der Schaltschrank mit einem Dreikant zu öffnen ist, UND wenn die Notentriegelung mit einem Dreikant geht, ist bei diesem Punkt IMMER „ohne Mängel“ anzukreuzen.\nWenn der Notentriegelungsschlüssel fehlt, ist \"Prüfung weist Mängel auf\" anzuklicken. Bitte tragen Sie im Textfeld ein, ob man einen normalen Dreikant braucht, oder ob ein spezieller Schlüssel benötigt wird. (Das kann man an den Aufzugtüren sehen, gegebenenfalls mit Dreikant testen)",
			"chpo_priority": 0,
			"chpo_emergency_description": "",
		...
		{
			"chpo_headline": "GLASSCHEIBEN DES AUFZUGSCHACHTES OHNE BESCHÄDIGUNGEN",
			"chpo_description": "Prüfen Sie durch Inaugenscheinnahme des verglasten Aufzugschachtes von Aussen und gegebenenfalls auch während der Fahrt von Innen (soweit möglich) ob an der Verglasung des Aufzugschachtes irgendwelche Schäden zu erkennen sind.",
			"chpo_long_description": "Hierzu zählen auch gesprungene Scheiben.",
			"chpo_priority": 0,
			"chpo_emergency_description": "",
			"chpo_checklists": null
		},
	...
	checklists:[
		{
			"chli_name": "Basis",
			"chli_checkpoints": [2,3,4,5,6,7,8,9,10,16,17,18,23,25]
		},
		{
			"chli_name": "Standard",
			"chli_checkpoints": [0,1,3,4,5,6,7,8,9,10,16,17,18,23,24,25]
		}
	],
	estates: [
		{
